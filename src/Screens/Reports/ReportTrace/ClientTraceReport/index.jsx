...
import {
  downloadClientTraceReportDataXls,
  getClientTraceReportData,
  setCountPerPage,
  setInitialState,
  setPageNumber,
  setSorting,
...
const LobReceiptPayments = () => {
  ...
  const {
    ...
    pageNo,
    filter,
  } = useSelector((state) => state.clientTraceReport);
  ...
  const handleRefresh = () => {
    if (selectedOption.value) {
      ...
      dispatch(getClientTraceReportData(obj));
    }
  };
    ...
    <Stack gap="1rem">
      <div className="flex flex-col px-4">
        <div className="flex justify-between">
          <HeaderBreadcrum
            heading={"Client Trace Report"}
            path={["Reports", "Report Trace", "Client Trace Report"]}
          />
