...
import { setPmaBillingTrendViewFilters, setPageNumber } from "../../../Redux/slice/reporting/pmaBillingTrendView";
import { useSelector } from "react-redux";

export function CustomFilterField(props) {
  const dispatch = useDispatch();
  const { filter } = useSelector((state) => state.pmaBillingTrendView);

  const handleFilterChange = (filters) => {
    dispatch(setPmaBillingTrendViewFilters({...filters}));
