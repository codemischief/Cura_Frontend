...
import { setBankTransferReconsiliationFilters , setPageNumber } from "../../../Redux/slice/reporting/BankTransferReconciliation";
import { useSelector } from "react-redux";

export function CustomFilterField(props) {
  const dispatch = useDispatch();
  const { filter } = useSelector((state) => state.bankTransferReconsiliation);

  const handleFilterChange = (filters) => {
    dispatch(setBankTransferReconsiliationFilters({...filters}));
