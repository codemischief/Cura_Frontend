...
const PmaClientReport = () => {
  ...
  const {
    ...
    pageNo,
    filter
  } = useSelector((state) => state.bankTransferReconsiliation)
  ...
  const handleRefresh = () => {
    ...
    dispatch(getBankTransferReconsiliation(obj));
  ...
  const downloadExcel = async () => {
    ...
    dispatch(downloadBankTransferReconsiliation(obj))
    // .then((response) => {
    ...
    <Stack gap="1rem">
      ...
      <div className="flex flex-col px-4">
        <div className="flex justify-between">
          <HeaderBreadcrum
            heading={"Bank Transfer Reconciliation"}
            path={["Reports", "Bank Records","Bank Transfer Reconciliation"]}
          />
        ...
        <SimpleTable
          columns={columns}
          data={bankTransferReconsiliation}
          pageNo={pageNo}
