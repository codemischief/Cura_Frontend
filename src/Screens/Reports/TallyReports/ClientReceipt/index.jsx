...
import {
  downloadClientReceiptReport,
  getClientReceiptView,
  setCountPerPage,
  setInitialState,
  setPageNumber,
  setSorting,
...
const ClientReceiptView = () => {
  ...
  const {
    ...
    pageNo,
    filter,
  } = useSelector((state) => state.clientReceiptReport);
  ...
  const handleRefresh = () => {
    if (intialFields.start_date && intialFields.end_date && intialFields.mode && intialFields.entity) {
      ...
      dispatch(getClientReceiptView(obj));
    }
  };
    ...
    <Stack gap="1rem" sx={{ paddingTop: "20px" }}>
      <div className="flex flex-col px-4">
        <div className="flex justify-between">
          <HeaderBreadcrum
            heading={"Client Receipts-BankMode"}
            path={["Reports", "Tally Report", "Client Receipts-BankMode"]}
          />
