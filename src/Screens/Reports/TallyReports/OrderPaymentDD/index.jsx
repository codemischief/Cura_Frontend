...
import {
  downloadorderPaymentDDReport,
  getorderPaymentDDView,
  setCountPerPage,
  setInitialState,
  setPageNumber,
  setSorting,
...
const OrderPaymentDDView = () => {
  ...
  const {
    ...
    pageNo,
    filter,
  } = useSelector((state) => state.orderPaymentDDReport);
  ...
  const handleRefresh = () => {
    if (
      ...
      dispatch(getorderPaymentDDView(obj));
    }
  };
...
export default OrderPaymentDDView;
