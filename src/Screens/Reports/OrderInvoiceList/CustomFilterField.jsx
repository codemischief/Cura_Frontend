...
import { setOrderInvoiceFilters, setPageNumber } from "../../../Redux/slice/reporting/OrderInvoiceSlice";
import { useSelector } from "react-redux";

export function CustomFilterField(props) {
  const dispatch = useDispatch();
  const { filter } = useSelector((state) => state.orderInvoice);

  const handleFilterChange = (filters) => {
    dispatch(setOrderInvoiceFilters({...filters}));
