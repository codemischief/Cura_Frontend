...
import { setBankReceiptReconciliationFilters, setPageNumber } from "../../../Redux/slice/reporting/BankReceiptsReconciliation";
import { useSelector } from "react-redux";

export function CustomFilterField(props) {
  const dispatch = useDispatch();
  const { filter } = useSelector((state) => state.bankReceiptReconciliation);

  const handleFilterChange = (filters) => {
    dispatch(setBankReceiptReconciliationFilters({...filters}));
