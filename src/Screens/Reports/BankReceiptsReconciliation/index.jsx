...
import {
  downloadBankReceiptReconciliation,
  getBankReceiptReconciliation,
  setCountPerPage,
  setInitialState,
  setPageNumber,
  setSorting,
  setStatus,
} from "../../../Redux/slice/reporting/BankReceiptsReconciliation";
...
const LobReceiptPayments = () => {
  ...
  const {
    ...
    pageNo,
    filter,
  } = useSelector((state) => state.bankReceiptReconciliation);
  ...
  const handleRefresh = () => {
      ...
      dispatch(getBankReceiptReconciliation(obj));
  };
    ...
    <Stack gap="1rem">
      ...
      <div className="flex flex-col px-4">
        <div className="flex justify-between">
          <HeaderBreadcrum
            heading={"Daily Bank Receipt Reconciliation"}
            path={["Reports", "Bank Records", "Daily Bank Receipt Reconciliation"]}
          />
        ...
        <SimpleTableWithFooter
          ...
          columns={columns}
          data={bankReceiptReconciliation}
