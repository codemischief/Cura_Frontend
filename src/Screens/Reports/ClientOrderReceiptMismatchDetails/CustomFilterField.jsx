...
import { setClientOrderReceiptMismatchDetailsFilters , setPageNumber } from "../../../Redux/slice/reporting/ClientOrderReceiptMismatchDetails";
import { useSelector } from "react-redux";

export function CustomFilterField(props) {
  const dispatch = useDispatch();
  const { filter } = useSelector((state) => state.clientOrderReceiptMismatchDetails);

  const handleFilterChange = (filters) => {
    dispatch(setClientOrderReceiptMismatchDetailsFilters({...filters}));
