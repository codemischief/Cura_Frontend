...
const Payments = () => {
  ...
  const selectedPaymentMode = ["1", "2", "3", "4"];
  const selectedMonth = [
    {
      id: 1,
      month: "Jan",
  ...
  const newHandleFilter = async (
    ...
    if (type == "noFilter" || type == "isNull" || type == "isNotNull")
      setInputVariable("");
    ...
    <div className="font-medium">
      ...
      {showSuccess && (
        <SucessfullModal
          ...
          message="New Contractual Payment Created Successfully"
        />
      )}
      {showEditSuccess && (
        <SucessfullModal
      ...
      {showCancelModelAdd && (
        <CancelModel
          ...
          message="Process cancelled, No Contractual payment created"
        />
      )}
      {showCancelModel && (
        <CancelModel
            ...
            <div className="w-[85%] flex items-center">
              ...
              <div className="w-[13%]  px-4 py-3">
                <div className="w-[100%] flex items-center bg-[#EBEBEB] rounded-md">
                  <input
                    ...
                    value={paymentToFilterInput}
                    onChange={(e) => setPaymentToFilterInput(e.target.value)}
                    onKeyDown={(event) =>
                      handleEnterToFilter(
                        event,
                        paymentToFilterInput,
                  ...
                  />
                  {filterMapState.paymentto.filterType == "" ? (
                    <button
                      className="w-[25%] px-1 py-2"
                      onClick={() => setPaymentToFilter((prev) => !prev)}
                    >
                ...
                {paymentToFilter && (
                  <CharacterFilter
                    inputVariable={paymentToFilterInput}
                    setInputVariable={setPaymentToFilterInput}
                    handleFilter={newHandleFilter}
                    filterColumn="paymentto"
                    menuRef={menuRef}
                    filterType={filterMapState.paymentto.filterType}
                  />
                )}
              </div>
              <div className="w-[13%]  px-4 py-3">
                <div className="w-[100%] flex items-center bg-[#EBEBEB] rounded-md">
                  <input
                    className="w-[75%] bg-[#EBEBEB] rounded-md text-xs pl-2 outline-none"
                    value={paymentByFilterInput}
                    onChange={(e) => setPaymentByFilterInput(e.target.value)}
                    onKeyDown={(event) =>
                      handleEnterToFilter(
                        event,
                        paymentByFilterInput,
                  ...
                  />
                  {filterMapState.paymentby.filterType == "" ? (
                    <button
                      className="w-[25%] px-1 py-2"
                      onClick={() => setPaymentByFilter((prev) => !prev)}
                    >
                      <img src={Filter} className="h-3 w-3" />
                    </button>
                  ) : (
                ...
                {paymentByFilter && (
                  <CharacterFilter
                    inputVariable={paymentByFilterInput}
                    setInputVariable={setPaymentByFilterInput}
                    handleFilter={newHandleFilter}
                    filterColumn="paymentby"
                    menuRef={menuRef}
                    filterType={filterMapState.paymentby.filterType}
                  />
                )}
              </div>
              <div className="w-[10%] px-4 py-3">
                <div className="w-[100%] flex items-center bg-[#EBEBEB] rounded-md">
                  ...
                  />
                  {filterMapState.amount.filterType == "" ? (
                    <button
                      className="w-[30%] px-1 py-2"
                      onClick={() => setAmountFilter((prev) => !prev)}
                    >
                      <img src={Filter} className="h-3 w-3" />
                    </button>
                  ) : (
                ...
                {amountFilter && (
                  <NumericFilter
                    inputVariable={amountFilterInput}
                    setInputVariable={setAmountFilterInput}
                    handleFilter={newHandleFilter}
                    columnName="amount"
                    menuRef={menuRef}
                    filterType={filterMapState.amount.filterType}
                  />
                )}
              </div>
              <div className="w-[10%]  px-4 py-3">
                <div className="w-[100%] flex items-center bg-[#EBEBEB] rounded-md">
                  ...
                  />
                  {filterMapState.paidon.filterType == "" ? (
                    <button
                      className="w-[30%] px-1 py-2"
                      onClick={() => setPaidOnFilter((prev) => !prev)}
                    >
                      <img src={Filter} className="h-3 w-3" />
                    </button>
                  ) : (
                ...
                {paidOnFilter && (
                  <DateFilter
                    inputVariable={paidOnFilterInput}
                    setInputVariable={setPaidOnFilterInput}
                    handleFilter={newHandleFilter}
                    columnName="paidon"
                    menuRef={menuRef}
                    filterType={filterMapState.paidon.filterType}
                  />
                )}
              </div>
              <div className="w-[14%]  px-4 py-3">
                <div className="w-[90%] flex items-center bg-[#EBEBEB] rounded-md">
                  <input
                    className="w-[75%] bg-[#EBEBEB] rounded-md text-xs pl-2 outline-none"
                    value={paymentModeFilterInput}
                    onChange={(e) => setPaymentModeFilterInput(e.target.value)}
                    onKeyDown={(event) =>
                      handleEnterToFilter(
                        event,
                        paymentModeFilterInput,
                  ...
                  />
                  {filterMapState.paymentmode.filterType == "" ? (
                    <button
                      className="w-[25%] px-1 py-2"
                      onClick={() => setPaymentModeFilter((prev) => !prev)}
                    >
                      <img src={Filter} className="h-3 w-3" />
                    </button>
                  ) : (
                ...
                {paymentModeFilter && (
                  <CharacterFilter
                    inputVariable={paymentModeFilterInput}
                    setInputVariable={setPaymentModeFilterInput}
                    handleFilter={newHandleFilter}
                    filterColumn="paymentmode"
                    menuRef={menuRef}
                    filterType={filterMapState.paymentmode.filterType}
                  />
                )}
              </div>
              <div className="w-[13%]  px-4 py-3">
                <div className="w-[100%] flex items-center bg-[#EBEBEB] rounded-md">
                  <input
                    className="w-[75%] bg-[#EBEBEB] rounded-md text-xs pl-2 outline-none"
                    value={paymentForFilterInput}
                    onChange={(e) => setPaymentForFilterInput(e.target.value)}
                    onKeyDown={(event) =>
                      handleEnterToFilter(
                        event,
                        paymentForFilterInput,
                  ...
                  />
                  {filterMapState.paymentfor.filterType == "" ? (
                    <button
                      className="w-[25%] px-1 py-2"
                      onClick={() => setPaymentForFilter((prev) => !prev)}
                    >
                      <img src={Filter} className="h-3 w-3" />
                    </button>
                  ) : (
                ...
                {paymentForFilter && (
                  <CharacterFilter
                    inputVariable={paymentForFilterInput}
                    setInputVariable={setPaymentForFilterInput}
                    handleFilter={newHandleFilter}
                    filterColumn="paymentfor"
                    menuRef={menuRef}
                    filterType={filterMapState.paymentfor.filterType}
                  />
                )}
              </div>
              ...
              <div className="w-[10%]  px-4 py-3">
                <div className="w-[100%] flex items-center bg-[#EBEBEB] rounded-md">
                  ...
                  />
                  {filterMapState.entity.filterType == "" ? (
                    <button
                      className="w-[30%] px-1 py-2"
                ...
                {entityFilter && (
                  <CharacterFilter
                    ...
                    filterColumn="entity"
                    menuRef={menuRef}
                    filterType={filterMapState.entity.filterType}
                  />
                )}
              </div>
            </div>
          ...
          <div className="w-full h-12 bg-[#F0F6FF] flex justify-between">
            <div className="w-[85%] flex">
              ...
              <div className="w-[13%]  p-4">
                <p>
                  Payment To{" "}
                  <button onClick={() => handleSort("paymentto")}>
              ...
              <div className="w-[13%]  p-4">
                <p>
                  Payment By{" "}
                  <button onClick={() => handleSort("paymentby")}>
                    <span className="font-extrabold">↑↓</span>
                  </button>
                </p>
              </div>
              ...
              <div className="w-[10%]  p-4">
                <p>
                  Paid On{" "}
                  <button onClick={() => handleSort("paidon")}>
                    <span className="font-extrabold">↑↓</span>
                  </button>
                </p>
              </div>
              <div className="w-[14%]  p-4">
                <p>
                  Payment Mode{" "}
                  <button onClick={() => handleSort("paymentmode")}>
                    <span className="font-extrabold">↑↓</span>
                  </button>
                </p>
              </div>
              <div className="w-[13%]  p-4">
                <p>
                  Payment For{" "}
                  <button onClick={() => handleSort("paymentfor")}>
                    <span className="font-extrabold">↑↓</span>
                  </button>
                </p>
              </div>
          ...
          <div className=" w-full h-[calc(100vh_-_17rem)] overflow-auto">
            ...
            {!pageLoading &&
              existingPayments.map((item, index) => {
                return (
                  <div className="w-full min-h-10 h-auto  flex justify-between items-center border-gray-400 border-b-[1px]">
            ...
            {isEditDialogue && (
              <EditPayments
                ...
                fetchData={fetchData}
                openPrompt={openEditSuccess}
                showCancel={openCancelModal}
              />
            )}
            {showDelete && (
              <Delete
                openDialog={isDeleteDialogue}
      ...
      >
        <>
          <Draggable handle="div.move">
            <div className="">
              <div className="w-[1100px]  h-auto bg-white rounded-lg relative">
                    ...
                    <div className=" space-y-3 py-5">
                      ...
                      <div className="">
                       ...
                       <ClientPropertySelectNative
                        ...
                        {/* <PaymentDropDown
                          options={allUsername}
                          initialValue="Select Payment To"
                          leftLabel="Name"
                          rightLabel="Username"
                          leftAttr="name"
                          rightAttr="username"
                      ...
                      <div className="">
                        ...
                        {/* <PaymentDropDown
                          options={allUsername}
                          initialValue="Select Payment By"
                          leftLabel="Name"
                          rightLabel={"Username"}
                          leftAttr="name"
                          rightAttr="username"
