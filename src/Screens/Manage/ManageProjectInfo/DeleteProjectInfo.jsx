                ...
                {/* <Draggable> */}
                    <div className='bg-white rounded-lg '>
                        <div className="w-full h-auto flex flex-col justify-center items-center relative ">
                            <div className="h-[40px] w-full rounded-lg flex justify-center items-center bg-[#EDF3FF]">
                            ...
                            <div className="mt-4 w-[80%] text-center ">
                                <p>Are you sure you want to delete this project '{props.projectName}'?</p>
                            </div>
...
export default DeleteProjectInfo;