...
const EditProjectInformation = ({formValues,setFormValues,projectTypeData,builderNameData,formErrors,state}) => {
    const {user} = useAuth()
            ...
            <div className="flex items-center justify-evenly mt-5 ">
                ...
                <div className="space-y-4">
                    <div className="">
                        ...
                        {state?.hyperlinked ? <div className="w-56 h-5 border-[1px] border-[#C6C6C6] rounded-sm px-3 text-xs py-0.5 bg-[#F5F5F5]" type="text" name="curaoffice" value={'hehe'} >{state.buildername}</div> : 
                        <select
                            className="w-56 h-5 border-[1px] border-[#C6C6C6] rounded-sm px-3 text-[11px]"
                            name="builderid"
