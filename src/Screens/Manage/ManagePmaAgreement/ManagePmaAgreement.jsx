...
const ManagePmaArgreement = () => {
  ...
  const [propertyDescriptionFilter, setPropertyDescriptionFilter] =
    useState(false);
  const [propertyDescriptionFilterInput, setPropertyDescriptionFilterInput] =
    useState("");
  ...
  const [propertyStatusFilterInput, setPropertyStatusFilterInput] =
    useState("");
    ...
    <div className="h-screen">
      ...
      {showAddSuccess && (
        <SucessfullModal
          ...
          message="New PMA Agreement Created Successfully"
        />
      )}
      {showDeleteSuccess && (
        <SucessfullModal
          isOpen={showDeleteSuccess}
          message="Successfully Deleted Pma Agreement"
        />
      )}
      {showEditSuccess && (
        <SucessfullModal
      ...
      {openAddConfirmation && (
        <SaveConfirmationPmaAgreement
          addPmaAgreement={addPmaAgreement}
      ...
      <div className="h-[calc(100vh_-_7rem)] w-full  px-10">
          ...
          <div className="flex space-x-2 items-center">
            <div className="flex bg-[#EBEBEB] ">
              ...
              <button onClick={handleCloseSearch}>
                <img src={Cross} className=" w-[20px] h-[20px] mx-2" />
              </button>
        ...
        <div className="w-full h-12 flex justify-between border-gray-400 border-b-[1px] text-xs">
          <div className="w-[90%] flex">
            <div className="w-[2%] flex">
              <div className="px-3 py-5">{/* <p>Sr.</p> */}</div>
            </div>
            ...
            <div className="w-[14.8%] px-3 py-2 ">
              <div className="w-[80%] flex items-center bg-[#EBEBEB] rounded-md">
                <input
                  ...
                  value={propertyDescriptionFilterInput}
                  onChange={(e) =>
                    setPropertyDescriptionFilterInput(e.target.value)
                  }
                />
                <button
                  className="w-[25%] px-1 py-2"
                  onClick={() => {
                    setPropertyDescriptionFilter((prev) => !prev);
                  }}
                >
                  <img src={Filter} className="h-3 w-3" />
                </button>
              </div>
              {propertyDescriptionFilter && (
                <CharacterFilter
                  inputVariable={propertyDescriptionFilterInput}
                  setInputVariable={setPropertyDescriptionFilterInput}
                  handleFilter={newHandleFilter}
                  filterColumn="propertydescription"
                  menuRef={menuRef}
                />
              )}
            </div>
            <div className="w-[9.8%]  px-3 py-2 ">
              <div className="w-[100%] flex items-center bg-[#EBEBEB] rounded-md">
                ...
                <button
                  className="w-[32%] px-1 py-2"
                  onClick={() => {
                    setOrderDescriptionFilter((prev) => !prev);
                  }}
                >
                  <img src={Filter} className="h-3 w-3" />
                </button>
            ...
            <div className="w-[8.8%] px-3 py-2 ">
              <div className="w-[100%] flex items-center bg-[#EBEBEB] rounded-md">
                <input
                  className="w-[68%] bg-[#EBEBEB] rounded-md text-xs pl-2 outline-none"
                  value={propertyStatusFilterInput}
                  onChange={(e) => setPropertyStatusFilterInput(e.target.value)}
                />
                <button
                  className="w-[32%] px-1 py-2"
                  onClick={() => {
                    setPropertyStatusFilter((prev) => !prev);
                  }}
                >
                  <img src={Filter} className="h-3 w-3" />
                </button>
              ...
              {propertyStatusFilter && (
                <CharacterFilter
                  inputVariable={propertyStatusFilterInput}
                  setInputVariable={setPropertyStatusFilterInput}
                  handleFilter={newHandleFilter}
                  filterColumn="propertystatusname"
                  menuRef={menuRef}
                />
              )}
            </div>
            <div className="w-[9.8%] px-3 py-2 ">
              <div className="w-[100%] flex items-center bg-[#EBEBEB] rounded-md">
                ...
                <button
                  className="w-[32%] px-1 py-2"
                  onClick={() => {
                    setDescriptionFilter((prev) => !prev);
                  }}
                >
                  <img src={Filter} className="h-3 w-3" />
                </button>
              ...
              {descriptionFilter && (
                <CharacterFilter
                  inputVariable={descriptionFilterInput}
                  setInputVariable={setDescriptionFilterInput}
                  handleFilter={newHandleFilter}
            ...
            <div className="w-[7.8%] px-3 py-2">
              ...
              {statusFilter && (
                <CharacterFilter
                  inputVariable={statusFilterInput}
                  setInputVariable={setStatusFilterInput}
                  handleFilter={newHandleFilter}
                  filterColumn="status"
                  menuRef={menuRef}
                />
            ...
            <div className="w-[9.8%] px-3 py-2 ">
              <div className="w-[100%] flex items-center bg-[#EBEBEB] rounded-md">
                <input
                  className="w-[68%] bg-[#EBEBEB] rounded-md text-xs pl-2 outline-none"
                  value={pmaStartFilterInput}
                  onChange={(e) => setPmaStartFilterInput(e.target.value)}
                  type="date"
                />
                <button
                  className="w-[32%] px-1 py-2"
                  onClick={() => {
                    setPmaStartFilter((prev) => !prev);
                  }}
                >
                  <img src={Filter} className="h-3 w-3" />
                </button>
              ...
              {pmaStartFilter && (
                <DateFilter
                  inputVariable={pmaStartFilterInput}
                  setInputVariable={setPmaStartFilterInput}
                  handleFilter={newHandleFilter}
            ...
            <div className="w-[8.8%] px-3 py-2  ">
              <div className="w-[100%] flex items-center bg-[#EBEBEB] rounded-md">
                <input
                  className="w-[68%] bg-[#EBEBEB] rounded-md text-xs pl-2 outline-none"
                  value={pmaEndFilterInput}
                  onChange={(e) => setPmaEndFilterInput(e.target.value)}
                  type="date"
                />
                <button
                  className="w-[32%] px-1 py-2"
                  onClick={() => {
                    setPmaEndFilter((prev) => !prev);
                  }}
                >
                  <img src={Filter} className="h-3 w-3" />
                </button>
              ...
              {pmaEndFilter && (
                <DateFilter
                  inputVariable={pmaEndFilterInput}
                  setInputVariable={setPmaEndFilterInput}
                  handleFilter={newHandleFilter}
                  columnName="enddate"
                  menuRef={menuRef}
                />
            ...
            <div className="w-[8.8%] px-3 py-2 ">
              <div className="w-[100%] flex items-center bg-[#EBEBEB] rounded-md">
                <input
                  className="w-[68%] bg-[#EBEBEB] rounded-md text-xs pl-2 outline-none"
                  value={poaStartFilterInput}
                  onChange={(e) => setPoaStartFilterInput(e.target.value)}
                  type="date"
                />
                <button
                  className="w-[32%] px-1 py-2"
                  onClick={() => {
                    setPoaStartFilter((prev) => !prev);
                  }}
                >
                  <img src={Filter} className="h-3 w-3" />
                </button>
              ...
              {poaStartFilter && (
                <DateFilter
                  inputVariable={poaStartFilterInput}
                  setInputVariable={setPoaStartFilterInput}
                  handleFilter={newHandleFilter}
                  columnName="poastartdate"
                  menuRef={menuRef}
                />
              )}
            </div>
            <div className="w-[8.8%] px-3 py-2">
              <div className="w-[100%] flex items-center bg-[#EBEBEB] rounded-md">
                <input
                  className="w-[68%] bg-[#EBEBEB] rounded-md text-xs pl-2 outline-none"
                  value={poaEndFilterInput}
                  onChange={(e) => setPoaEndFilterInput(e.target.value)}
                  type="date"
                />
                <button
                  className="w-[32%] px-1 py-2"
                  onClick={() => {
                    setPoaEndFilter((prev) => !prev);
                  }}
                >
                  <img src={Filter} className="h-3 w-3" />
                </button>
              ...
              {poaEndFilter && (
                <DateFilter
                  inputVariable={poaEndFilterInput}
                  setInputVariable={setPoaEndFilterInput}
                  handleFilter={newHandleFilter}
                  columnName="poaenddate"
                  menuRef={menuRef}
                />
              )}
            </div>
          ...
          <div className="w-[10%] flex">
            <div className="w-[65%] px-3 py-2 ">
              <div className="w-[100%] flex items-center bg-[#EBEBEB] rounded-md">
                <input
                  className="w-[68%] bg-[#EBEBEB] rounded-md text-xs pl-2 outline-none"
                  value={poaHolderFilterInput}
                  onChange={(e) => setPoaHolderFilterInput(e.target.value)}
                />
                <button
                  className="w-[32%] px-1 py-2"
                  onClick={() => {
                    setPoaHolderFilter((prev) => !prev);
                  }}
                >
                  <img src={Filter} className="h-3 w-3" />
                </button>
              ...
              {poaHolderFilter && (
                <CharacterFilter
                  inputVariable={poaHolderFilterInput}
                  setInputVariable={setPoaHolderFilterInput}
                  handleFilter={newHandleFilter}
                  filterColumn="poaholder"
                  menuRef={menuRef}
                />
              )}
            </div>
            <div className="w-[35%]  flex">
              <div className="px-3 py-5"></div>
            </div>
          </div>
        </div>
        ...
        <div className="h-[calc(100vh_-_14rem)] w-full text-[12px]">
          <div className="w-full h-16 bg-[#F0F6FF] flex justify-between border-gray-400 border-b-[1px]">
            <div className="w-[90%] flex">
              ...
              <div className="w-[14.8%]  flex">
                <div className="px-3 py-5">
                  <p>
                    ...
                    <button onClick={() => handleSort("propertydescription")}>
                      <span className="font-extrabold">↑↓</span>
                    </button>
                  </p>
                </div>
              ...
              <div className="w-[9.8%]  flex ">
                ...
                <button onClick={() => handleSort("orderdescription")}>
                  <span className="font-extrabold ">↑↓</span>
                </button>
              </div>
              <div className="w-[8.8%]  flex">
                ...
                <button onClick={() => handleSort("propertystatusname")}>
                  <span className="font-extrabold">↑↓</span>
                </button>
              </div>
              <div className="w-[9.8%]  flex">
              ...
              <div className="w-[8.8%]  flex">
                ...
                <button onClick={() => handleSort("poastartdate")}>
                  <span className="font-extrabold">↑↓</span>
                </button>
              </div>
              <div className="w-[8.8%]  flex">
                ...
                <button onClick={() => handleSort("poaenddate")}>
                  <span className="font-extrabold">↑↓</span>
                </button>
              </div>
            </div>
            <div className="w-[10%] flex">
              <div className="w-[65%]  flex">
                ...
                <button onClick={() => handleSort("poaholder")}>
                  <span className="font-extrabold">↑↓</span>
                </button>
              </div>
              <div className="w-[35%]  flex">
          ...
          <div className="w-full h-[calc(100vh_-_18rem)] overflow-auto">
            ...
            {!pageLoading &&
              existingPmaAgreement.map((item, index) => {
                return (
                  <div className="w-full h-auto bg-white flex justify-between border-gray-400 border-b-[1px]">
                    <div className="w-[90%] flex">
                      <div className="w-[2%] flex">
                        <div className="px-3 py-5">
                      ...
                      <div className="w-[8.8%]  flex">
                        <div className="p-3">{item.propertystatusname}</div>
                      </div>
                      <div className="w-[9.8%]  flex">
                        <div className="px-3 py-5">
                      ...
                      <div className="w-[7.8%]  flex">
                        <div className="p-3 ml-1 flex items-center space-x-2">
                          {item.active ? (
                            <>
                              <div className="w-[7px] h-[7px] rounded-xl bg-green-600"></div>
                              <p>active</p>
                            </>
                          ) : (
                            <>
                              <div className="w-[7px] h-[7px] rounded-xl bg-red-600"></div>
                              <p> inactive</p>
                            </>
                          )}
                        </div>
      ...
      <div className="w-full h-12 flex justify-between justify-self-end px-6 mt-5 fixed bottom-0 bg-white ">
        ...
        <div className="flex mr-10 justify-center items-center space-x-2 ">
          ...
          <div className="flex text-sm">
            {console.log("totalItems, currentPages", totalItems, currentPages)}
                  ...
                  <div className="flex gap-[48px] justify-center ">
                    <div className=" space-y-3 py-5">
                      ...
                      <div className="">
                        ...
                        <input
                          ...
                          type="date"
                          name="pmaStartDate"
                          value={formValues.pmaStartDate}
                          onChange={handleChange}
                        />
                        <div className="text-[10px] text-[#CD0000] ">
                          {formErrors.pmaStartDate}
                        </div>
                      </div>
                      <div className="">
                        ...
                        <input
                          ...
                          type="date"
                          name="poaStartDate"
                          value={formValues.poaStartDate}
                          onChange={handleChange}
                        />
                        <div className="text-[10px] text-[#CD0000] ">
                          {formErrors.poaStartDate}
                        </div>
                      </div>
                      <div className="">
                        <div className="text-[13px]">
                    ...
                    <div className=" space-y-3 py-5">
                      <div className="">
                        ...
                        <div className="text-[10px] text-[#CD0000] ">
                          {formErrors.clientProperty}
                        </div>
                      </div>
                      <div className="">
                        <div className="text-[13px]">
                          PMA End Date <label className="text-red-500">*</label>
                        </div>
                        <input
                          className="w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm px-3 text-[11px]"
                          type="date"
                          name="pmaEndDate"
                          value={formValues.pmaEndDate}
                          onChange={handleChange}
                        />
                        <div className="text-[10px] text-[#CD0000] ">
                          {formErrors.pmaEndDate}
                        </div>
                      </div>
                      <div className="">
                        ...
                        <input
                          ...
                          type="date"
                          name="poaEndDate"
                          value={formValues.poaEndDate}
                          onChange={handleChange}
                        />
                        <div className="text-[10px] text-[#CD0000] ">
                          {formErrors.poaEndDate}
                        </div>
                      </div>
                      <div className="">
                        ...
                        <input
                          ...
                          type="text"
                          name="poaHolderName"
                          value={formValues.poaHolderName}
                          onChange={handleChange}
                        />
                      </div>
                      <div className="">
