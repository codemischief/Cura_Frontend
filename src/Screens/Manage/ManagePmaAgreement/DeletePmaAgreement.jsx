...
const DeletePmaAgreement = (props) => {
                        ...
                        <div className="w-auto h-auto flex flex-col justify-center items-center ">
                            <div className="h-[40px] flex justify-center items-center">
                                <div className="ml-56 mr-52">
                                    <div className="text-[16px] font-semibold">Delete PMA Agreement</div>
                                </div>
                            ...
                            <div className="mt-4 w-full text-center">
                                <p>Are you sure you want to delete the PMA Agreement?</p>
                            </div>
...
export default DeletePmaAgreement;