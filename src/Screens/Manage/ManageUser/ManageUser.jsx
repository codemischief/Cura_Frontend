                ...
                <div className="w-auto h-auto bg-white rounded-lg">
                    <div className="h-[40px] bg-[#EDF3FF]  justify-center flex items-center">
                        ...
                        <div className="flex justify-center items-center rounded-full w-[30px] h-[30px] bg-white">
                            <Link to="/manageuser"><img onClick={handleClose} className="w-[20px] h-[20px]" src={Cross} alt="cross" /></Link>
                        </div>
                    </div>
                            ...
                            <div className="flex gap-[48px] justify-center items-center">
                                ...
                                <div className=" space-y-[12px] py-[20px] px-[10px]">
                                    ...
                                    <div className="">
                                        ...
                                        <select className="w-[230px] hy-[10px] border-[1px] border-[#C6C6C6] rounded-sm" name="role" value={formValues.role} onChange={handleChange} >
