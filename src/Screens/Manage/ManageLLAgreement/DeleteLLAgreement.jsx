                        ...
                        <div className="w-auto h-auto flex flex-col justify-center items-center ">
                            <div className="h-[40px] bg-[#EDF3FF] flex justify-center items-center relative">
                                <div className="ml-56 mr-52">
                                    <div className="text-[16px]">Delete L&L Agreement</div>
                                </div>
                            ...
                            <div className="mt-4 w-full text-center">
                                <p>Are you sure you want to delete the L&L Agreement?</p>
                            </div>
...
export default DeleteLLAgreement;