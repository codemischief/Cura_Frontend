...
const ManageVendorInvoice = () => {
  ...
  const fetchUsersData = async () => {
    ...
    (existing.receivedBy = res.data[0].id), setFormValues(existing);
    ...
    <div className="w-full font-medium">
      ...
      {showAddSuccess && (
        <SucessfullModal
          ...
          message="New Vendor Invoice created successfully"
        />
      )}
      {showDeleteSuccess && (
        <SucessfullModal
      ...
      {showDeleteModal && (
        <DeleteVendorInvoice
          ...
          item={currVendorInvoice}
          handleDelete={deleteVendorInvoice}
          showCancel={openCancelModal}
        />
      )}
      {showCancelModelAdd && (
        <CancelModel
          ...
          message="Process cancelled, no Vendor Invoice added."
        />
      )}
      {showCancelModel && (
        <CancelModel
      ...
      <div className="h-[calc(100vh_-_123px)] w-full  px-10">
          ...
          <div className="w-[90%] flex">
            ...
            <div className="w-[13%] px-3 py-2  ">
              <div className="w-[80%] flex items-center bg-[#EBEBEB] rounded-md">
                <input
                  ...
                  onChange={(e) => setVendorNameFilterInput(e.target.value)}
                  onKeyDown={(event) =>
                    handleEnterToFilter(
                      event,
                      vendorNameFilterInput,
                      setVendorNameFilterInput,
                      "contains",
                      "vendorname"
                    )
                ...
                />
                {filterMapState.vendorname.filterType == "" ? (
                  <button
                    className="w-[30%] px-1 py-2"
                    onClick={() => setVendorNameFilter((prev) => !prev)}
                  >
              ...
              {vendorNameFilter && (
                <CharacterFilter
                  inputVariable={vendorNameFilterInput}
                  setInputVariable={setVendorNameFilterInput}
                  handleFilter={newHandleFilter}
                  filterColumn="vendorname"
                  menuRef={menuRef}
                  filterType={filterMapState.vendorname.filterType}
                />
              )}
            </div>
            ...
            <div className="w-[16%] px-3 py-2 ml-[2px]">
              <div className="w-[70%] flex items-center bg-[#EBEBEB] rounded-md ml-0.5">
                ...
                />
                {filterMapState.briefdescription.filterType == "" ? (
                  <button
                    className="w-[30%] px-1 py-2"
              ...
              {orderDescriptionFilter && (
                <CharacterFilter
                  ...
                  handleFilter={newHandleFilter}
                  filterColumn="briefdescription"
                  menuRef={menuRef}
                  filterType={filterMapState.briefdescription.filterType}
                />
              )}
            </div>
            ...
            <div className="w-[10%] px-3 py-2 ">
              <div className="w-[100%] flex items-center bg-[#EBEBEB] rounded-md">
                <input
                  ...
                  onChange={(e) => setInvoiceAmountFilterInput(e.target.value)}
                  onKeyDown={(event) =>
                    handleEnterToFilter(
                      event,
            ...
            <div className="w-[10%] px-3 py-2  ">
              <div className="w-[70] flex items-center bg-[#EBEBEB] rounded-md">
                <input
                  className="w-[75%] bg-[#EBEBEB] rounded-md text-xs pl-2 outline-none"
                  type="number"
                  value={estimateAmountFilterInput}
                  onChange={(e) => setEstimateAmountFilterInput(e.target.value)}
                  onKeyDown={(event) =>
                    handleEnterToFilter(
                      event,
                      estimateAmountFilterInput,
                      setEstimateAmountFilterInput,
                      "equalTo",
                      "amount"
                    )
                ...
                {filterMapState.amount.filterType == "" ? (
                  <button
                    className="w-[30%] px-1 py-2"
                    onClick={() => setEstimateAmountFilter((prev) => !prev)}
                  >
                    <img src={Filter} className="h-3 w-3" />
                  </button>
                ) : (
              ...
              {estimateAmountFilter && (
                <NumericFilter
                  columnName="amount"
                  inputVariable={estimateAmountFilterInput}
                  setInputVariable={setEstimateAmountFilterInput}
                  handleFilter={newHandleFilter}
                  menuRef={menuRef}
            ...
            <div className="w-[10%] px-3 py-2  ">
              <div className="w-[85%] flex items-center bg-[#EBEBEB] rounded-md">
                <input
                  className="w-[75%] bg-[#EBEBEB] rounded-md text-xs pl-2 outline-none"
                  value={estimateDateFilterInput}
                  onChange={(e) => setEstimateDateFilterInput(e.target.value)}
                  type="date"
                  onKeyDown={(event) =>
                    handleEnterToFilter(
                      event,
                      estimateDateFilterInput,
                      setEstimateDateFilterInput,
                      "equalTo",
                      "estimatedate"
                    )
                ...
                />
                {filterMapState.estimatedate.filterType == "" ? (
                  <button
                    className="w-[30%] px-1 py-2"
                    onClick={() => setEstimateDateFilter((prev) => !prev)}
                  >
                    <img src={Filter} className="h-3 w-3" />
                  </button>
                ) : (
              ...
              {estimateDateFilter && (
                <DateFilter
                  inputVariable={estimateDateFilterInput}
                  setInputVariable={setEstimateDateFilterInput}
                  handleFilter={newHandleFilter}
                  columnName="estimatedate"
                  menuRef={menuRef}
                  filterType={filterMapState.estimatedate.filterType}
                />
              )}
            </div>
          </div>
            ...
            <div className="w-[55%] px-3 py-2 ">
              <div className="w-[100%] flex items-center bg-[#EBEBEB] rounded-[5px]">
                <input
                  ...
                  type="number"
                  value={idFilterInput}
                  onChange={(e) => setIdFilterInput(Number(e.target.value))}
                  onKeyDown={(event) =>
                    handleEnterToFilter(
                      event,
                      idFilterInput,
        ...
        <div className="h-[calc(100vh_-_14rem)] w-full text-[12px]">
            ...
            <div className="w-[90%] flex">
              ...
              <div className="w-[13%]  flex">
                <div className="px-3 py-5">
                  <p>
                    Vendor Name{" "}
                    <button onClick={() => handleSort("vendorname")}>
              ...
              <div className="w-[16%]  flex ">
                ...
                <button onClick={() => handleSort("briefdescription")}>
                  <span className="font-extrabold">↑↓</span>
                </button>
              </div>
              <div className="w-[10%]  flex">
              ...
              <div className="w-[10%]  flex">
                ...
                <button onClick={() => handleSort("estimatedate")}>
                  <span className="font-extrabold">↑↓</span>
                </button>
              </div>
            </div>
          ...
          <div className="w-full h-[calc(100vh_-_18rem)] overflow-auto">
            ...
            {!pageLoading &&
              existingVendorInvoice &&
              existingVendorInvoice.length == 0 && (
                <div className="h-10 border-gray-400 border-b-[1px] flex items-center">
                  <h1 className="ml-10">No Records To Show</h1>
                </div>
              )}
            {!pageLoading &&
              existingVendorInvoice.map((item, index) => {
                return (
                  <div className="w-full h-auto min-h-10 bg-white flex justify-between items-center border-gray-400 border-b-[1px] py-1">
                ...
                <div className="flex gap-[48px] justify-center ">
                  <div className=" space-y-3 py-5">
                    <div className="">
                      ...
                      <div
                        className="w-56 h-[20px] border-[1px] border-[#C6C6C6] rounded-sm px-3 text-xs py-0.5 bg-[#F5F5F5]"
                        type="text"
                        name="curaoffice"
                    ...
                    <div className="pt-0.5">
                      ...
                      <select
                        className="w-56 h-[20px] border-[1px] border-[#C6C6C6] rounded-sm px-3 text-[11px]"
                        name="vendor"
                  ...
                  <div className=" space-y-3 py-5">
                    ...
                    <div className="">
                      ...
                      <textarea
                        className="w-56 h-[80px] border-[1px] border-[#C6C6C6] rounded-sm px-3 text-[11px] resize-none"
                        type="text"
