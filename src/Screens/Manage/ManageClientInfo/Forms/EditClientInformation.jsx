...
const EditClientInformation = ({
  ...
  const [tenantofLoading, setTenantLoading] = useState(false)
  ...
  const getClientPropertyByClientId = async (id) => {
    ...
    if (formValues?.client_info?.tenantofproperty === null) {
      setFormValues(prevFormValues => ({
        ...prevFormValues,
        client_info: {
          ...prevFormValues.client_info,
          tenantofproperty: res.data[0]?.id || null
        }
      }));
    }
  };
  ...
  useEffect(() => {
    console.log(formValues?.client_info?.tenantof, "formValues?.client_info");
  }, [formValues?.client_info])
          ...
          <div className=" space-y-3 py-2">
            <div className="">
              <div className="text-[13px]">
                Salutation <label className="text-red-500">*</label>
              </div>
              <select
            ...
            <div className="">
              <div className="text-[13px]">
                Client Type <label className="text-red-500">*</label>
              </div>
              <select
                className="text-[11px] px-3 w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm"
                value={formValues.client_info.clienttype}
                onChange={(e) => {
                  setFormValues({
                    ...formValues,
                    client_info: {
            ...
            <div className="">
              ...
              <input
                ...
                type="text"
                name="addressline1"
                value={formValues.client_info.addressline1}
                onChange={handleChange}
              />
            ...
            <div className="">
              ...
              <input
                ...
                name="email1"
                onChange={handleChange}
                value={formValues.client_info.email1}
              />
              {/* <div className="text-[8px] text-[#CD0000] absolute ">{formErrors.amount}</div> */}
              <div className="text-[8px] text-[#CD0000] absolute ">
                {formErrors.email1}
            ...
            <div className="">
              ...
              <input
                className="text-[11px] px-3 w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm"
                type="text"
                name="localcontact1name"
                onChange={handleChange}
                value={formValues.client_info.localcontact1name}
              />
              {/* <div className="text-[8px] text-[#CD0000] absolute ">{formErrors.amount}</div> */}
            </div>
            <div className="">
              ...
              <input
                className="text-[11px] px-3 w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm"
                type="text"
                name="localcontact2name"
                onChange={handleChange}
                value={formValues.client_info.localcontact2name}
              />
              {/* <div className="text-[8px] text-[#CD0000] absolute ">{formErrors.amount}</div> */}
            </div>
            <div className="">
              <div className="text-[13px]">
                Source <label className="text-red-500">*</label>
              </div>
              <select
                className="text-[11px] px-3 w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm"
                name="source"
                value={formValues.client_info.entityid}
                onChange={(e) => {
                  setFormValues({
                    ...formValues,
                    client_info: {
          ...
          <div className="space-y-3 py-2">
            <div className="">
              ...
              <input
                ...
                name="firstname"
                onChange={handleChange}
                value={formValues.client_info.firstname}
              />
              <div className="text-[8px] text-[#CD0000] absolute ">
            ...
            <div className="">
              <div className="text-[13px]">
                Country <label className="text-red-500">*</label>
              </div>
              <select
                className="text-[11px] px-3 w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm"
                name="country"
            ...
            <div className="">
              ...
              <input
                ...
                name="addressline2"
                onChange={handleChange}
                value={formValues.client_info.addressline2}
              />
              {/* <div className="text-[8px] text-[#CD0000] absolute ">{formErrors.amount}</div> */}
            </div>
            <div className="">
              ...
              <input
                ...
                name="email2"
                onChange={handleChange}
                value={formValues.client_info.email2}
              />
              <div className="text-[8px] text-[#CD0000] absolute ">
                {formErrors.email2}
              </div>
            ...
            <div className="">
              ...
              <input
                className="text-[11px] px-3 w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm"
                type="text"
                name="localcontact1details"
                onChange={handleChange}
                value={formValues.client_info.localcontact1details}
              />
              {/* <div className="text-[8px] text-[#CD0000] absolute ">{formErrors.amount}</div> */}
            </div>
            <div className="">
              ...
              <input
                className="text-[11px] px-3 w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm"
                type="text"
                name="localcontact2details"
                onChange={handleChange}
                value={formValues.client_info.localcontact2details}
              />
              {/* <div className="text-[8px] text-[#CD0000] absolute ">{formErrors.amount}</div> */}
            </div>
            <div className="">
              ...
              <input
                ...
                name="comments"
                onChange={handleChange}
                value={formValues.client_info.comments}
              />
              {/* <div className="text-[8px] text-[#CD0000] absolute ">{formErrors.amount}</div> */}
            </div>
          </div>
          <div className="space-y-3 py-2">
            <div className="">
              ...
              <input
                ...
                name="middlename"
                onChange={handleChange}
                value={formValues.client_info.middlename}
              />
              <div className="text-[8px] text-[#CD0000] absolute ">
            ...
            <div className="">
              ...
              <select
                className="text-[11px] px-3 w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm"
                name="state"
                value={formValues.client_info.state}
                onChange={(e) => {
                  setFormValues({
                    ...formValues,
                    client_info: {
            ...
            <div className="">
              ...
              <input
                ...
                name="zip"
                onChange={handleChange}
                value={formValues.client_info.zip}
              />
              {/* <div className="text-[8px] text-[#CD0000] absolute ">{formErrors.amount}</div> */}
            </div>
            <div className="">
              ...
              <input
                ...
                name="mobilephone"
                onChange={handleChange}
                value={formValues.client_info.mobilephone}
              />
              {/* <div className="text-[8px] text-[#CD0000] absolute ">{formErrors.amount}</div> */}
            </div>
            <div className="">
              ...
              <input
                className="text-[11px] px-3 w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm"
                type="text"
                name="localcontact1address"
                onChange={handleChange}
                value={formValues.client_info.localcontact1address}
              />
              {/* <div className="text-[8px] text-[#CD0000] absolute ">{formErrors.amount}</div> */}
            </div>
            <div className="">
              ...
              <input
                className="text-[10px] px-3 w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm"
                type="text"
                name="localcontact2address"
                onChange={handleChange}
                value={formValues.client_info.localcontact2address}
              />
              {/* <div className="text-[8px] text-[#CD0000] absolute ">{formErrors.amount}</div> */}
            </div>
            <div className="">
          ...
          <div className="space-y-3 py-2 mt-[5px]">
            <div className="">
              ...
              <input
                ...
                name="lastname"
                onChange={handleChange}
                value={formValues.client_info.lastname}
              />
              <div className="text-[8px] text-[#CD0000] absolute ">
                {formErrors.lastname}
              </div>
            ...
            <div className="">
              ...
              <input
                ...
                type="text"
                name="suburb"
                value={formValues.client_info.suburb}
                onChange={handleChange}
              />
              {/* <div className="text-[8px] text-[#CD0000] absolute ">{formErrors.amount}</div> */}
            </div>
            <div className="">
              ...
              <input
                ...
                name="homephone"
                onChange={handleChange}
                value={formValues.client_info.homephone}
              />
              {/* <div className="text-[8px] text-[#CD0000] absolute ">{formErrors.amount}</div> */}
            </div>
            <div className="">
              ...
              <input
                ...
                name="workphone"
                onChange={handleChange}
                value={formValues.client_info.workphone}
              />
              {/* <div className="text-[8px] text-[#CD0000] absolute ">{formErrors.amount}</div> */}
            </div>
            <div className="">
              ...
              <input
                ...
                name="employername"
                onChange={handleChange}
                value={formValues.client_info.employername}
              />
            </div>
            ...
            <div className="">
              ...
              <ClientPropertySelectNative
                ...
                value={
                  tenantOfProperty?.[formValues.client_info.tenantofproperty]
                    ?.propertyname
                    ? tenantOfProperty?.[formValues.client_info.tenantofproperty]
                      ?.propertyname
                    : null
                ...
                renderData={(item) => {
                  return (
                    <MenuItem
                      value={item}
                      key={item}
                      sx={{ width: "230px", gap: "5px", fontSize: "12px" }}
                    >
                      <p
                        className="w-[50%] "
                        style={{
