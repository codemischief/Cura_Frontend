            ...
            <div className="flex gap-10 justify-center items-center">
                ...
                <div className="space-y-2 py-2">
                    ...
                    <div className="">
                        ...
                        <select className="text-[11px] px-3 w-[230px] h-[10px] border-[1px] border-[#C6C6C6] rounded-sm" name="country" onChange={
                            (e) => {
                                setFormValues({
                                    ...formValues, client_info: {
                                        ...formValues.client_info,
                ...
                <div className="">
                    ...
                    <div className="">
                        ...
                        <input className="text-[11px] px-3 w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm" type="text" name="area" />
                        {/* <div className="text-[12px] text-[#CD0000] ">{formErrors.amount}</div> */}
                    </div>
                    <div className="">
