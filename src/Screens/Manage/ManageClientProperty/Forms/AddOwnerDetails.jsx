...
const AddOwnerDetails = (props) => {
  return (
    <div className="flex gap-10 justify-center mb-3">
        <div className="">
          <div className="text-[13px]">Owner {props.index+4} Name </div>
        ...
        <div className="">
          <div className="">
            <div className="text-[13px]">Owner {props.index+4} PAN NO </div>
        ...
        <div className="">
          <div className="">
            <div className="text-[13px]">Owner {props.index+4} Aadhar No </div>
