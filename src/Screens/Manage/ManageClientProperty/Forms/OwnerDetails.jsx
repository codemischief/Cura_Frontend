      ...
      <div className="h-auto w-full pt-5 pr-5 flex flex-col items-center ">
        ...
        <div className="flex  gap-4 mb-3">
          ...
          <div className="">
            ...
            <input className="text-[12px] pl-4 w-[160px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm" type="text" name="fullLegalName" />
            {/* <div className="text-[12px] text-[#CD0000] ">{formErrors.amount}</div> */}
          </div>
          <div className="">
            <div className="text-[13px]"> PAN NO </div>
            <input className="text-[12px] pl-4 w-[160px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm" type="text" name="panno" />
            {/* <div className="text-[12px] text-[#CD0000] ">{formErrors.amount}</div> */}
          </div>
          <div className="">
