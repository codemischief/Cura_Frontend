                ...
                <Draggable>
                    <div className='w-2/4 h-64 rounded-xl bg-white mx-auto mt-48' >
                        <div className="h-[40px] flex justify-center items-center">
                            <div className="w-[150px] mt-10 w-full text-center pl-8">
                                <div className="text-[24px]">Add Vendor Payment</div>
                        ...
                        <div className="mt-8 w-full text-center pl-4">
                            <div className="text-[14px]">New Vendor Payment</div>
                        </div>
                        <div className="mt-4 w-full text-center pl-4">
