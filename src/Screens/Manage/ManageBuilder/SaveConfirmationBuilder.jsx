    ...
    <Modal open={true} >
                <div className='w-2/4 h-64 rounded-xl bg-white mx-auto mt-48' >
                    ...
                    <div className="mt-8 w-full text-center">
                        <div className="text-[14px]">Builder Name : {props.currentBuilder}</div>
                    </div>
                    <div className="mt-4 w-full text-center">
                        <p className="text-[14px]">Are you sure you want to Add new Builder</p>
                    </div>
                    <div className="my-10 flex justify-center items-center gap-[10px]">
                        <button className='w-[132px] h-[48px] bg-[#004DD7] text-white rounded-md' onClick={props.addBuilder}>Save</button>
...
export default SaveConfirmationBuilder
