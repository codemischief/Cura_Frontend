...
const Prospect = () => {
  ...
  const [
    propertyLocationFilterInput,
    setPropertyLocationFilterInput,
  ] = useState("");
  const [possibleServicesFilter, setPossibleServicesFilter] = useState(false);
  const [
    possibleServicesFilterInput,
    setPossibleServicesFilterInput,
  ] = useState("");
  const [cancelPropectForm, setCancelProspectForm] = useState(false);

  useEffect(() => {
    setTimeout(() => {
      setCancelProspectForm(false);
    }, [3000]);
  }, [cancelPropectForm]);
    ...
    <div className="h-screen">
      ...
      {isEditDialogue && (
        <EditForm
          ...
          handleClose={() => {
            setIsEditDialogue(false), setCurrItem({});
          }}
          item={currItem}
          fetchData={fetchData}
      ...
      {showDeleteSuccess && (
        <SucessfullModal
          ...
          message="Prospect Deleted Succesffuly!"
        />
      )}
      {cancelPropectForm && (
        <CancelModel
          isOpen={cancelPropectForm}
          message={
            currItem
              ? "Process cancelled, no  Prospect edited."
          ...
          <div className="flex space-x-2 items-center relative">
            <div className="flex">
              ...
              <button onClick={handleCloseSearch}>
                <img
                  src={Cross}
                  className="absolute w-[20px] h-[20px] left-[160px] top-2"
                />
              </button>
            ...
            <div className="w-[85%] flex">
              ...
              <div className="w-[25%]  px-4 py-3">
                <div className="w-[37%] flex items-center bg-[#EBEBEB] rounded-[5px]">
                  <input
                    className="w-14 bg-[#EBEBEB] rounded-[5px] text-[11px] pl-2"
                ...
                {personFilter && (
                  <div
                    className="h-[270px] w-[150px] mt-3 bg-white shadow-xl font-thin font-sans absolute p-2 flex-col rounded-md space-y-1 text-sm z-40"
                    ref={menuRef}
                  >
              ...
              <div className="w-[15%]  px-4 py-3">
                <div className="w-[68%] flex items-center bg-[#EBEBEB] rounded-[5px]">
                  <input
                    className="w-14 bg-[#EBEBEB] rounded-[5px] text-[11px] pl-2"
                    value={suburbFilterInput}
                    onChange={(e) => setSuburbFilterInput(e.target.value)}
                  />
                  <button
                    className="p-1"
                    onClick={() => setSuburbFilter((prev) => !prev)}
                  >
                    <img src={Filter} className="h-[15px] w-[15px]" />
                  </button>
                </div>
                {suburbFilter && (
                  <div
              ...
              <div className="w-[20%]  px-4 py-3">
                <div className="w-[48%] flex items-center bg-[#EBEBEB] rounded-[5px]">
                  <input
                    className="w-14 bg-[#EBEBEB] rounded-[5px] text-[11px] pl-2"
                    value={propertyLocationFilterInput}
                    onChange={(e) =>
                      setPropertyLocationFilterInput(e.target.value)
                    }
                  />
                  <button
                    className="p-1"
                    onClick={() => setPropertyLocationFilter((prev) => !prev)}
                  >
                    <img src={Filter} className="h-[15px] w-[15px]" />
                  </button>
                </div>
              ...
              <div className="w-[20%]  px-4 py-3">
                <div className="w-[48%] flex items-center bg-[#EBEBEB] rounded-[5px]">
                  <input
                    className="w-14 bg-[#EBEBEB] rounded-[5px] text-[11px] pl-2"
                    value={possibleServicesFilterInput}
                    onChange={(e) =>
                      setPossibleServicesFilterInput(e.target.value)
                    }
                  />
                  <button
                    className="p-1"
                    onClick={() => setPossibleServicesFilter((prev) => !prev)}
                  >
                    <img src={Filter} className="h-[15px] w-[15px]" />
                  </button>
                </div>
                {possibleServicesFilter && (
                  <div
                    className="h-[270px] w-[150px] mt-3 bg-white shadow-xl font-thin font-sans absolute p-2 flex-col rounded-md space-y-1 text-sm z-40"
                    ref={menuRef}
                  >
          ...
          <div className="w-full h-12 bg-[#F0F6FF] flex justify-between border-gray-400 border-b-[1px]">
            <div className="w-[85%] flex">
              ...
              <div className="w-[25%]  p-4">
                <p>
                  Person Name <span className="font-extrabold">↑↓</span>
                </p>
              </div>
              <div className="w-[15%]  p-4">
                <p>
                  Suburb <span className="font-extrabold">↑↓</span>
                </p>
              </div>
              <div className="w-[15%]  p-4">
                <p>
                  City <span className="font-extrabold">↑↓</span>
                </p>
              </div>
              <div className="w-[20%]  p-4">
                <p>
                  Property Location <span className="font-extrabold">↑↓</span>
                </p>
              </div>
              <div className="w-[20%]  p-4">
                <p>
                  Possible Services <span className="font-extrabold">↑↓</span>
                </p>
              </div>
            </div>
            <div className="w-[15%] flex">
              <div className="w-1/2  p-4">
                <p>
                  ID <span className="font-extrabold">↑↓</span>
                </p>
              </div>
          ...
          <div className="w-full h-[calc(100vh_-_17rem)] overflow-y-auto overflow-x-hidden">
            ...
            {!pageLoading &&
              existingProspect.map((item, index) => {
                return (
                  <div className="w-full h-10 ml-1 flex justify-between border-gray-400 border-b-[1px]">
                    <div className="w-[85%] flex">
