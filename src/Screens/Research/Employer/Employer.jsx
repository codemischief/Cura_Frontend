                    ...
                    <div className='w-full  flex-col px-6'>
                        ...
                        <div className='h-1/2 w-full  flex justify-between items-center p-2  border-gray-300 border-b-2'>
                            <div className='flex items-center space-x-3'>
                                ...
                                <div className='flex-col'>
                                    <h1 className='text-[18px]'>Employer Information</h1>
                                    <p className='text-[14px]'>Research &gt; Employer</p>
                                </div>
                            </div>
                        ...
                        <div className='w-full h-12 bg-[#F0F6FF] flex justify-between'>
                            <div className='w-[85%] flex'>
                                ...
                                <div className='w-[20%]  p-4'>
                                    <p>Industry <span className="font-extrabold">↑↓</span></p>
                                </div>
                                <div className='w-[20%]  p-4'>
                                ...
                                <div className='w-[15%]  p-4'>
                                    <p>On Site Opportunity <span className="font-extrabold">↑↓</span></p>
                                </div>
                            </div>
                            <div className='w-[15%] flex'>
