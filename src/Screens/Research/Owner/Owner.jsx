...
const Owner = () => {
    ...
    const [isOwnerDialogue, setIsOwnerDialogue] = React.useState(false);
    const handleOpen = () => {
        setIsOwnerDialogue(true);
    };
    const handleClose = () => {
        setIsOwnerDialogue(false);
    }
    ...
    const handleDownload = () => {
        ...
        const worksheet = XLSX.utils.json_to_sheet(existingOwner);
                    ...
                    <div className='w-full  flex-col px-6'>
                        ...
                        <div className='h-1/2 w-full  flex justify-between items-center p-2  border-gray-300 border-b-2'>
                            <div className='flex items-center space-x-3'>
                                ...
                                <div className='flex-col'>
                                    <h1 className='text-[18px]'>Owner</h1>
                                    <p className='text-[14px]'>Research &gt; Owner</p>
                                </div>
                            </div>
                        ...
                        <div className='h-12 w-full bg-white'>
                            <div className='flex justify-between'>
                                ...
                                <div className='w-[15%] flex'>
                                    ...
                                    <div className='w-1/2 0 px-4 py-3'>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='w-full h-12 bg-[#F0F6FF] flex justify-between'>
                            <div className='w-[85%] flex'>
                                ...
                                <div className='w-[12%]  p-4'>
                                    <p>Corporation<span className="font-extrabold">↑↓</span></p>
                                </div>
                                <div className='w-[10%]  p-4'>
                                    <p>Name <span className="font-extrabold">↑↓</span></p>
                                </div>
                                <div className='w-[14%]  p-4'>
                                    <p>Property Tax No. <span className="font-extrabold">↑↓</span></p>
                                </div>
                                ...
                                <div className='w-[10%]  p-4'>
                                    <p>Sale/Rent <span className="font-extrabold">↑↓</span></p>
                                </div>
                                <div className='w-[14%]  p-4'>
                                    <p>Property Details <span className="font-extrabold">↑↓</span></p>
                                </div>
                                <div className='w-[12%]  p-4'>
                            ...
                            <div className='w-[15%] flex'>
                                <div className='w-1/2  p-4'>
                                    <p>Source <span className="font-extrabold">↑↓</span></p>
                                </div>
                    ...
                    <div className="w-6/7  h-auto bg-white rounded-lg">
                        <div className="h-[40px] bg-[#EDF3FF]  justify-center flex items-center">
                            <div className="mr-[410px] ml-[410px]">
                                <div className="text-[16px]">New Owner</div>
                            </div>
                            ...
                            <div className="h-auto w-full mt-[5px] ">
                                <div className="flex gap-[48px] justify-center">
                                    <div className=" space-y-[12px] py-[20px] px-[10px]">
                                        <div className="">
                                            <div className="text-[14px]">Corporation</div>
                                        ...
                                        <div className="">
                                            <div className="text-[14px]">Sale/Rent</div>
                                    ...
                                    <div className=" space-y-[12px] py-[20px] px-[10px]">
                                        <div className="">
                                            ...
                                            <input className="w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm" type="text" name="address" value={formValues.propertyTaxNo} onChange={handleChange} />
                                        </div>
                                        <div className="">
                                        ...
                                        <div className="">
                                            <div className="text-[14px]">Property Details </div>
                                            <input className="w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm" type="text" name="propertyDetails" value={formValues.propertyDetails} onChange={handleChange} />
                                        </div>
                                        <div className="">
                                        ...
                                        <div className="">
                                            ...
                                            <input className="w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm" type="text" name="source" value={formValues.source} onChange={handleChange} />
                                        </div>
                                    </div>
                                </div>
                            </div>
