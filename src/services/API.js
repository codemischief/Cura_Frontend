...
const addClientInvoice = async (data) => {
  const response = await fetch(`${env_URL_SERVER}addOrdersInvoice`, METHOD_POST(data));
  return response;
}
const deleteClientInvoice = async (data) => {
  const response = await fetch(`${env_URL_SERVER}deleteOrdersInvoice`, METHOD_POST(data));
  return response;
}
const getOrderStatusHistory = async (data) => {
  const response = await fetch(`${env_URL_SERVER}getOrderStatusHistory`, METHOD_POST(data));
  return response;
}
const editOrder = async (data) => {
  const response = await fetch(`${env_URL_SERVER}editOrders`, METHOD_POST(data));
  return response;
}
...
const addOrderStatusChange = async (data) => {
  const response = await fetch(`${env_URL_SERVER}addOrderStatusChange`, METHOD_POST(data));
  return response;
}

const getVendors = async (data) => {
  const response = await fetch(`${env_URL_SERVER}getVendors`, METHOD_POST(data));
  return response;
}
...
const deleteVendors = async (data) => {
  const response = await fetch(`${env_URL_SERVER}deleteVendors`, METHOD_POST(data));
  return response;
}
...
const addVendorsInvoice = async (data) => {
  const response = await fetch(`${env_URL_SERVER}addVendorInvoice`, METHOD_POST(data));
  return response;
}

const editProject = async (data) => {
  const response = await fetch(`${env_URL_SERVER}editProject`, METHOD_POST(data));
  return response;
}
const deleteVendorsInvoice = async (data) => {
  const response = await fetch(`${env_URL_SERVER}deleteVendorInvoice`, METHOD_POST(data));
  return response;
}
const editVendorInvoice = async (data) => {
  const response = await fetch(`${env_URL_SERVER}editVendorInvoice`, METHOD_POST(data));
  return response;
}
const getVendorCategoryAdmin = async (data) => {
  const response = await fetch(`${env_URL_SERVER}getVendorCategoryAdmin`, METHOD_POST(data));
  return response;
}
const getVendorPayment = async (data) => {
  const response = await fetch(`${env_URL_SERVER}getVendorPayment`, METHOD_POST(data));
  return response;
}
const addVendorPayment = async (data) => {
  const response = await fetch(`${env_URL_SERVER}addVendorPayment`, METHOD_POST(data));
  return response;
}
const editVendorPayment = async (data) => {
  const response = await fetch(`${env_URL_SERVER}editVendorPayment`, METHOD_POST(data));
  return response;
}
const deleteVendorPayment = async (data) => {
  const response = await fetch(`${env_URL_SERVER}deleteVendorPayment`, METHOD_POST(data));
  return response;
}
const editVendors = async (data) => {
  const response = await fetch(`${env_URL_SERVER}editVendors`, METHOD_POST(data));
  return response;
}
const addLLTenant = async (data) => {
  const response = await fetch(`${env_URL_SERVER}addLLTenant`, METHOD_POST(data));
  return response;
}
...
const deleteCities = async (data) => {
  const response = await fetch(`${env_URL_SERVER}deleteCities`, METHOD_POST(data));
  return response;
}
const editCities = async (data) => {
  const response = await fetch(`${env_URL_SERVER}editCities`, METHOD_POST(data));
  return response;
}
...
const getService = async (data) => {
  const response = await fetch(`${env_URL_SERVER}getServices`, METHOD_POST(data));
  return response;
}
const addService = async (data) => {
  const response = await fetch(`${env_URL_SERVER}addService`, METHOD_POST(data));
  return response;
}
const editService = async (data) => {
  const response = await fetch(`${env_URL_SERVER}editService`, METHOD_POST(data));
  return response;
}
const deleteService = async (data) => {
  const response = await fetch(`${env_URL_SERVER}deleteService`, METHOD_POST(data));

  return response;
}
const deleteLLTenant = async (data) => {
  const response = await fetch(`${env_URL_SERVER}deleteLLTenant`, METHOD_POST(data));

  return response;
}
const getLLTenant = async (data) => {
  const response = await fetch(`${env_URL_SERVER}getLLTenant`, METHOD_POST(data));
