...
return response;
 ...
 const addOrder = async (data) => {
  const response = await fetch(`${env_URL_SERVER}addOrder`, METHOD_POST(data));
  return response;
 }
