                            ...
                            <div className="flex gap-[48px] justify-center items-center">
                                <div className=" space-y-[12px] py-[20px] px-[10px]">
                                    <div className="">
                                        ...
                                        <input className="w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm" type="text" name="empName" value={formValues.nameOfTheUser} onChange={handleChange} />
                                    ...
                                    <div className="">
                                        ...
                                        <input className="w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm" type="text" name="panNo" value={formValues.userName} onChange={handleChange} />
                                    ...
                                    <div className="">
                                        ...
                                        <input className="w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm" type="text" name="panNo" value={formValues.password} onChange={handleChange} />
                                    ...
                                    <div className="">
                                        ...
                                        <input className="w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm" type="date" name="doj" value={formValues.lob} onChange={handleChange} />
                                    ...
                                    <div className="">
                                        ...
                                        <input className="w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm" type="text" name="desc" value={formValues.email} onChange={handleChange} />
                                        <div className="text-[12px] text-[#CD0000] ">{formErrors.email}</div>
                                    </div>
                                    <div className="">
                                        <div className="text-[14px]">Work Phone</div>
                                        <input className="w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm" type="email" name="email"/>
                                    </div>
                                    <div className="">
                                        <div className="text-[14px]">Address Line 1<label className="text-red-500">*</label></div>
                                        <input className="w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm" type="text" name="add" value={formValues.addressLine1} onChange={handleChange}/>
                                ...
                                <div className=" space-y-[12px] py-[20px] px-[10px]">
                                    <div className="">
                                        ...
                                        <input className="w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm" type="text" name="empId" />
                                    </div>
                                    <div className="">
                                        <div className="text-[14px]">Effective Date<label className="text-red-500">*</label></div>
                                        <input className="w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm" type="date" name="lob" value={formValues.effectiveDate} onChange={handleChange} />
                                    ...
                                    <div className="">
                                        ...
                                        <input className="w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm" type="text" name="dob" value={formValues.confirmPassword} onChange={handleChange} />
                                    ...
                                    <div className="">
                                        ...
                                        <input className="w-[230px] h-[20px] border-[1px] border-[#C6C6C6] rounded-sm" type="text" name="phNo" value={formValues.homePhone} onChange={handleChange} />
