...
const ManageBuilder = (props) => {
  ...
  return (
    <div>
      ...
      <ManageBuilderModal openDialog={openDialog} setOpenDialog={setOpenDialog}></ManageBuilderModal> 
      ...
      <div className="mx-[10px] mt-[10px] px-[20px] pt-[10xp] bg-white w-[1260px] h-[500px] rounded-sm">
        <div className="flex items-center gap-[600px] h-[45px]">
          <div className="flex items-center gap-[10px]">
            ...
            <div>
              <div className="text-md">Manage Builder</div>
              <div className="text-[12px]">Admin - Manage Builder</div>
            </div>
          </div>
