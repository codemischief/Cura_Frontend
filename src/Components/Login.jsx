            ...
            <div className="space-y-[12px]">
              ...
              <div className="space-y-[2px]">
                ...
                <input
                  ...
                  autoComplete="off"
                />
                <span className="w-[20px] h-[20px] absolute right-[438px] bottom-[316px]">
                  <img
                ...
                <div className="text-[10px] text-[#CD0000] invisible">{formErrors.password}</div>
              </div>
              <div className="space-y-[2px]">
                ...
                <input
                  ...
                  autoComplete="off"
                />
                <span className="w-[20px] h-[20px] absolute right-[438px] bottom-[228px]">
                  <img
                    className='cursor-pointer'
                    onClick={passwordToggle}
                    src={eyeIcon}
                ...
                <div className="text-[10px] text-[#CD0000] invisible">{formErrors.comkey}</div>
              </div>
            </div>
            <div className="w-[450px] h-[74px] bg-[#FFEAEA] rounded-[15px] border-[1px] border-[#CD0000] flex justify-center items-center px-[45px] py-[20px] text-[14px] invisible">
